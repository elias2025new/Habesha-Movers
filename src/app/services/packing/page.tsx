...
export default function PackingServicesPage() {
    ...
    return (
        <div className="bg-white min-h-screen font-sans text-gray-900 pb-20">
            ...
            <section className="relative h-[85vh] w-full overflow-hidden flex items-center">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full text-center">
                    ...
                    >
                        ...
                        <motion.p variants={fadeIn} className="text-xl text-gray-200 max-w-2xl mx-auto leading-relaxed">
                        ...
                        <motion.div variants={fadeIn} className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
                            <Link href="/quote">
                                <Button className="bg-[#8B3A2C] hover:bg-[#702e23] text-white px-8 py-7 rounded-full text-lg font-semibold shadow-lg transition-all w-full sm:w-auto flex items-center justify-center gap-3">
                                    Get a Packing Quote <ArrowRight className="w-5 h-5" />
                                </Button>
                            </Link>
                            <Link href="tel:0999220000">
                                <Button variant="outline" className="border-white/30 text-white hover:bg-white/10 px-8 py-7 rounded-full text-lg font-semibold w-full sm:w-auto">
                                    Call 0999220000
                                </Button>
                            </Link>
                        </motion.div>
            ...
            <section className="py-24 bg-[#FDF8F7]">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Premium Materials Only</h2>
                        <p className="text-lg text-gray-600">We don't cut corners. We use industry-leading packing supplies to ensure your items withstand any journey.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={idx} className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 text-center group">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div className="relative">
                            ...
                            <div className="relative rounded-[1.5rem] overflow-hidden shadow-2xl h-[500px]">
                                <Image
                            ...
                            {/* Badge */}
                            <div className="absolute -bottom-8 -right-8 bg-white p-6 rounded-2xl shadow-xl border border-gray-100 flex items-center gap-4">
                                <div className="p-3 bg-[#F5A623]/20 rounded-full">
                                    <Gem className="w-8 h-8 text-[#F5A623]" />
                                </div>
                                <div>
                                    <p className="font-bold text-gray-900 text-lg">White Glove</p>
                                    <p className="text-sm text-gray-500">Certified Handling</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mt-6 mb-8 leading-tight">
                            ...
                            <div className="mt-10">
                                <Link href="/contact">
                                    <Button className="bg-gray-900 hover:bg-black text-white px-8 py-6 rounded-lg font-bold">
            ...
            <section className="py-24 bg-[#8B3A2C] text-white">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-12 gap-8">
                        <div>
                            <h2 className="text-3xl md:text-5xl font-bold mb-4">Our Quality Promise</h2>
                            <p className="text-white/80 text-lg max-w-xl">Every box we pack goes through a strict verification process to ensure organized and safe delivery.</p>
                        </div>
                        <ClipboardCheck className="w-24 h-24 text-[#F5A623] opacity-50" />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={idx} className="bg-white/10 backdrop-blur border border-white/10 p-6 rounded-xl hover:bg-white/20 transition-colors">
                                <h3 className="font-bold text-xl mb-2 text-[#F5A623]">{card.title}</h3>
            ...
            <section className="py-24 bg-white text-center">
                <div className="max-w-4xl mx-auto px-6">
                    <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-8">Ready to Save Your Back?</h2>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Link href="/quote">
                            <Button className="bg-[#8B3A2C] hover:bg-[#702e23] text-white px-10 py-8 rounded-full text-xl font-bold shadow-xl transition-all w-full sm:w-auto">
                                Get a Quote
                            </Button>
                        </Link>
                        <Link href="tel:0999220000">
                            <Button variant="outline" className="border-gray-200 text-gray-900 hover:bg-gray-50 px-10 py-8 rounded-full text-xl font-bold w-full sm:w-auto flex items-center justify-center gap-2">
