    ...
    if (isSuccess) {
        return (
            <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8 max-w-2xl mx-auto border border-gray-100 dark:border-gray-700 transition-colors">
                ...
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">{t('quoteForm.successTitle')}</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">{t('quote.fullName')}</label>
                    ...
                    {/* Email */}
                    <div className="space-y-2">
                        <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">{t('quote.email')}</label>
                    ...
                    {/* Phone */}
                    <div className="space-y-2">
                        <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">{t('quote.phone')}</label>
                    ...
                    {/* House Size */}
                    <div className="space-y-2">
                        <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">{t('quoteForm.houseOrOffice')}</label>
                        <select
                            {...register('houseSize')}
                    ...
                    {/* Pickup Address */}
                    <div className="space-y-2">
                        <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">{t('quote.pickup')}</label>
                    ...
                    {/* Destination Address */}
                    <div className="space-y-2">
                        <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">{t('quote.destination')}</label>
                    ...
                    {/* Moving Date */}
                    <div className="space-y-2">
                        <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">{t('quoteForm.movingDatePref')}</label>
                ...
                {/* Notes */}
                <div className="space-y-2">
                    <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">{t('quote.notes')}</label>
                    <textarea
                        {...register('notes')}
