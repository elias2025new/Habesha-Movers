...
const AdminHeader = ({ user }: AdminHeaderProps) => {
    return (
        <header className="h-16 bg-white  border-b border-gray-200  flex items-center justify-between px-8 transition-colors">
            ...
            <div className="flex items-center space-x-4 sm:space-x-6">
                ...
                <div className="flex items-center space-x-3 pl-4 sm:pl-6 border-l border-gray-200 ">
