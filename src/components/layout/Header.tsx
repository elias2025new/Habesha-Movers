...
const Header = () => {
    ...
    return (
        <div className="fixed w-full z-50">
            ...
            {/* Main Header */}
            <header className="bg-white/95 dark:bg-[#121212] backdrop-blur-md shadow-sm dark:border-b dark:border-[#1F1F1F] transition-colors">
                ...
                {/* Mobile Navigation */}
                {isOpen && (
                    <div className="lg:hidden bg-white dark:bg-[#121212] border-b border-gray-100 dark:border-[#1F1F1F] animate-in slide-in-from-top duration-300 shadow-xl max-h-[calc(100vh-80px)] overflow-y-auto">
                        <div className="px-4 pt-4 pb-6 space-y-2">
                                    ...
                                    {item.hasDropdown ? (
                                        <>
                                            <button
                                                ...
                                                className="flex w-full items-center justify-between px-3 py-3 text-base font-medium text-gray-600 dark:text-[#E6E6E6] hover:text-primary dark:hover:text-[#F5A623] hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg"
                                            >
                                                {item.name}
                                                ...
                                                <div className="pl-6 space-y-1">
                                                    {services.map((service) => (
                                                        <Link
                                                            key={service.name}
                                                            href={service.href}
                                                            className="block px-3 py-2 text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-primary dark:hover:text-[#F5A623] rounded-lg"
                                        ...
                                        <Link
                                            href={item.href}
                                            className="block px-3 py-3 text-base font-medium text-gray-600 dark:text-[#E6E6E6] hover:text-primary dark:hover:text-[#F5A623] hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg"
                                            onClick={() => setIsOpen(false)}
                                        >
                                            {item.name}
                                        </Link>
                            ...
                            <div className="pt-4 mt-4 border-t border-gray-100 dark:border-[#1F1F1F]">
                                <Button
                                    className="w-full justify-center gap-2 font-bold dark:bg-transparent dark:border-[#8B3A2C] dark:text-[#F2F2F2] dark:hover:bg-[#8B3A2C]"
                                    variant="primary"
                                >
